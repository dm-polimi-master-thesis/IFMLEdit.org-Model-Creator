    ...
    editable: function () {
        ...
        if (graph) {
            ...
            var pattern = [],
                types = [],
                nodes = [],
                values = ['alphabetical filter','basic search','content management','faceted search','in-place log in','input data validation','master detail','multilevel master detail','restricted search','sign up and log in','wizard'],
